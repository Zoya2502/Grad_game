...
const SCENES = {
    ...
    'zarya_d1_order': { text: "Полуденная Заря выпрямляется, прогоняя напряженную тишину.\n«Ну ладно, – произносит она тихим голосом. – Приготовишь чего-нибудь? Пельменей каких-то, например».", speaker: "Полуденная Заря", guestSprite: "zarya", type: 'order_placed', order: 'dumplings' },
    ...
    'osetrik_d2_order': { text: "«Слушай, сделай мне чего-нибудь, а? Только с чаем. И без мяса. А то, знаешь, один повар был так увлечен нарезкой мяса, что сам не заметил, как начал отдавать себя работе», – он усердно делает серьезное лицо. Мне на мгновение кажется, что Экранчик над моей головой фыркает.", speaker: "Осетрик", guestSprite: "osetrik", type: 'order_placed', order: 'tea' },
...
const SCREENY_DIALOGUES = {
    ...
    'screen_q_place': {
        text: "«Это? О, это чудесное место! Вы находитесь в сердцевине кафе «Дримсайд»! Ваша цель — сделать гостей счастливыми!»",
