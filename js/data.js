...
const HORROR_SCENES = {
    // --- ЧЕРНЫЙ МУРЛЫКА ---
    'murlyka_horror': {
        text: "Колокольчик на двери не звенит. Чёрный Мурлыка просто появляется перед прилавком, пока я отворачиваюсь на секунду в сторону шелеста за спиной. Он стоит. Неподвижно. Слишком прямо и правильно даже для него. Его хвост не раскачивается, а дёргается, резко, рвано, как сломанный метроном.",
        speaker: "",
        guestSprite: "murlyka",
        choices: [
            { text: "С тобой всё хорошо?", target: 'murlyka_h_good', karma: 1 },
            { text: "З-закрыто. Уходи", target: 'murlyka_h_bad', karma: -1 }
        ]
    },
    'murlyka_h_good': {
        text: "Он продолжает молчать несколько секунд. Затем фыркает. В этом звуке нет его привычной теплоты, убаюкивающего спокойствия. Лишь холодная, безразличная насмешка.\n«Разумеется, – его голос надтрескивается в громкую статику посреди слова. – Почему бы со мной что-то было плохо?»",
        speaker: "Чёрный Мурлыка",
        next: 'murlyka_h_order'
    },
    'murlyka_h_bad': {
        text: "Медленно, мучительно медленно его голова начинает наклоняться, всё дальше и дальше, под неестественным углом, почти параллельно полу.\nЧёрный Мурлыка не отвечает. Просто улыбается и продолжает смотреть, стоя неподвижно, как статуя. Статуя, вылепленная каким-то больным на голову скульптором.",
        speaker: "",
        next: 'murlyka_h_order'
    },
    'murlyka_h_order': {
        text: "Он наконец делает шаг вперёд, опираясь на прилавок всем своим весом. Его разноцветные глаза всё ещё прикованы ко мне.\n«Сделай мне что-то, – журчит он, – что мы оба любим». (Стейк)",
        speaker: "Чёрный Мурлыка",
        type: 'order_placed',
        order: 'steak' // Любимое блюдо
    },

    // --- ПЛАМЕНЕЮЩАЯ ---
    'plamen_horror': {
        text: "Колокольчик бряцает едва слышно, холодно. Будто кто-то намеренно провёл когтем по стеклу. Две пары шагов – одна слишком резкая, порывистая, вторая – механически ровная – приближаются к прилавку. Незабудочка встаёт на цыпочки, её улыбка широкая, статичная. Рядом с ней замирает Пламенеющая. Её улыбка зеркально повторяет дочернюю.\n«Привет, ба, – голос Незабудочки звучит ровно, без детских переливов. – Мы пришли».",
        speaker: "",
        guestSprite: "plamen",
        next: 'plamen_h_1'
    },
    'plamen_h_1': {
        text: "Пламенеющая медленно наклоняет голову под прямым углом, не отрывая от меня взгляда.\n«Привет-привет. Как дела?» – интонация плоская, словно заученная фраза.",
        speaker: "Пламенеющая",
        choices: [
            { text: "Круто", target: 'plamen_h_good', karma: 1 },
            { text: "Отстаньте от меня", target: 'plamen_h_bad', karma: -1 }
        ]
    },
    'plamen_h_good': {
        text: "«Хорошо, – Незабудочка отвечает мгновенно, не меняя выражения лица. – Мы видели уток. В парке».\nОна замирает в позе, будто держит невидимое перо, но лапа пуста. Пальцы Пламенеющей зависают над макушкой дочери, не касаясь её.\n«Да. Они хотели печенье. Все печенье», – её глаза не моргают.",
        speaker: "Незабудочка",
        next: 'plamen_h_order'
    },
    'plamen_h_bad': {
        text: "Пламенеющая наклоняет голову в другую сторону. Её улыбка не дрогнула, но веки чуть опускаются, делая взгляд тяжёлым. «Всё в порядке?» – голос тише, но всё такой же монотонный.\nИх взгляд давит. Тяжелее, чем давил взгляд Экранчика раньше. Я качаю головой пренебрежительно.",
        speaker: "Пламенеющая",
        next: 'plamen_h_order'
    },
    'plamen_h_order': {
        text: "«Так вот, – продолжает Пламенеющая ровно, абсолютно безэмоционально. – Любимое Незабудочки. Сейчас. Мы торопимся». (Двойное комбо)",
        speaker: "Пламенеющая",
        type: 'order_placed',
        order: 'sweet_combo_duo' // Любимое блюдо
    },

    // --- ТЕПЛЫЙ ВЕЧЕР ---
    'vecher_horror': {
        text: "Теплый Вечер уже стоит спиной за прилавком, глядя в стену. Непонятно, как он сюда попал. Как только я поднимаю на него взгляд, он разворачивается не всем телом, а только торсом. Ноги остаются на месте.\n«Опа, – его голос слегка дребезжит. – А я-то думал, вы уже закрылись».",
        speaker: "",
        guestSprite: "vecher",
        next: 'vecher_h_1'
    },
    'vecher_h_1': {
        text: "Он делает шаг вперёд. Движение слишком плавное, будто его протащили по кадру. Его слова слипаются время от времени, как мокрый снег.\n«Повестка дня. Твоёповедение. Все голоса против. Един-гласно».",
        speaker: "Тёплый Вечер",
        choices: [
            { text: "Прости", target: 'vecher_h_good', karma: 1 },
            { text: "Это не твоё дело", target: 'vecher_h_bad', karma: -1 }
        ]
    },
    'vecher_h_good': {
        text: "Улыбка на его лице наконец меняется. Она не исчезает, а расслаивается, становится ещё шире, обнажая чуть больше зубов.\n«Про-сти, – он растягивает слово, наслаждаясь звуком. – Поздно. Оно уже не лечит. Констатирует. Поломку. Приятно осознавать. Свою поломку, правда?»",
        speaker: "Тёплый Вечер",
        next: 'vecher_h_order'
    },
    'vecher_h_bad': {
        text: "«Не моё, – он кивает, не сводя с меня глаз. – Общее. Нашдом. Наши правила. Ты нарушаешь. Правила. Нашугеометрию. Все должно быть гладким. Как стекло».",
        speaker: "Тёплый Вечер",
        next: 'vecher_h_order'
    },
    'vecher_h_order': {
        text: "«Дай мне чего-нибудь. – Теплый Вечер чеканит, не сводя с меня глаз. – Нестыдного. Не такого горького, как оправдания». (Карбонара)",
        speaker: "Тёплый Вечер",
        type: 'order_placed',
        order: 'carbonara' // Любимое блюдо
    },

    // --- ПОЛУДЕННАЯ ЗАРЯ ---
    'zarya_horror': {
        text: "Колокольчик звякает, звук затягивается, превращаясь в тонкий металлический писк. Шаги тяжелые, ровные, как метроном. К прилавку подходит Полуденная Заря. Голова слегка наклонена, взгляд устремлён на меня, не мигая.\n«Воздух у тебя тут стоит. Не двигается».",
        speaker: "Полуденная Заря",
        guestSprite: "zarya",
        choices: [
            { text: "Обычный, вроде", target: 'zarya_h_good', karma: 1 },
            { text: "Воздух как воздух, что нужно-то?", target: 'zarya_h_bad', karma: -1 }
        ]
    },
    'zarya_h_good': {
        text: "Уголки её губ медленно поднимаются в улыбку, которая не доходит до глаз. Зрачки кажутся слишком тёмными и сфокусированными.\n«Конечно. Стабильный. Нормальный, – её ладонь скользит по столешнице одним резким, механическим движением, будто она что-то смахивает. – У тебя норма сбилась. Я чувствую пустоту».",
        speaker: "Полуденная Заря",
        next: 'zarya_h_order'
    },
    'zarya_h_bad': {
        text: "«Веж, – её голова кренится набок, улыбка становится лишь шире. Неестественно шире, как у Экранчика, что всё ещё висит над моей головой с холодным, расчётливым подобием дружелюбия. – Ливость».",
        speaker: "Полуденная Заря",
        next: 'zarya_h_order'
    },
    'zarya_h_order': {
        text: "Она стучит пальцем по прилавку, медленный, размеренный, почти механический тук-тук-тук.\n«Дай мне чего-то, что голод утолит, – её глаза сужаются до щёлок. – Не в желудке». (Китайские пельмени)",
        speaker: "Полуденная Заря",
        type: 'order_placed',
        order: 'dumplings_chinese' // Любимое блюдо
    },

    // --- ПЕСНЬ СОЛНЦА ---
    'sun_horror': {
        text: "Песнь Солнца заходит, – хотя, скорее заплывает, – в кафе. Её движения слишком плавные, слишком ровные. Даже дверной колокольчик, кажется, не потревожен её входом.\n«Приветствую, – слово произнесено чётко, но с микроскопическими паузами, будто его печатают. – Ты как?»",
        speaker: "Песнь Солнца",
        guestSprite: "sun",
        choices: [
            { text: "Нормально…", target: 'sun_h_good', karma: 1 },
            { text: "Что с тобой?", target: 'sun_h_bad', karma: -1 }
        ]
    },
    'sun_h_good': {
        text: "Её голова наклоняется. Градусов сорок к полу, не больше.\n«Нормально? Это хо-ршо. Правильно, – она медленно кладет обе ладони на стойку. Пальцы лежат слишком ровно. – Здесь все должно быть. Нормально».",
        speaker: "Песнь Солнца",
        next: 'sun_h_order'
    },
    'sun_h_bad': {
        text: "Её улыбка становится чуть-чуть шире. Глаза всё так же не моргают.\n«Со мной? – она повторяет слова, будто впервые их слышит. – Я здесь. Пришла. Ты же-звала, – Песнь Солнца делает паузу. Некомфортно долгую. – Всякий раз. Когда говоришь грубость. Я слышу. И прихожу. Посмотреть».",
        speaker: "Песнь Солнца",
        next: 'sun_h_order'
    },
    'sun_h_order': {
        text: "Песнь Солнца наклоняется ближе. Я инстинктивно делаю шаг назад. Мелодия на фоне ломается слегка, словно из-за напряжения в молчаливом взгляде.\n«Сделай мне что-то. Что мне понравится». (Рыба в сливках)",
        speaker: "Песнь Солнца",
        type: 'order_placed',
        order: 'fish_creamy' // Любимое блюдо
    },

    // --- ОСЕТРИК ---
    'osetrik_horror': {
        text: "«Да так... – он пожимает плечами. – Мой «вечный двигатель» решил стать одноразовым. Взорвался. Немного. Никто не пострадал, кроме моей гордости и маминого горшка с геранью... прости».",
        speaker: "Осётрик",
        guestSprite: "osetrik",
        next: 'osetrik_h_1'
    },
    'osetrik_h_1': {
        text: "Он наконец смотрит на меня, и в его глазах – редкая для него неуверенность.\n«Я думал, у меня получается... А оно – бац. Ладно. Можно я просто посижу тут немного? И... поем чего-нибудь?»",
        speaker: "Осётрик",
        choices: [
            { text: "Конечно", target: 'osetrik_h_good', karma: 1 },
            { text: "Я же говорила тебе перестать возиться с хламом", target: 'osetrik_h_bad', karma: -1 }
        ]
    },
    'osetrik_h_good': {
        text: "Осетрик медленно поднимает взгляд. В нем нет радости, только пустота. «Спасибо... мама?»",
        speaker: "Осётрик",
        next: 'osetrik_h_order'
    },
    'osetrik_h_bad': {
        text: "Слово «хлам» тяжело повисает в воздухе. Осётрик резко втягивает воздух, как будто его укололи. Всё его тело мгновенно выпрямляется, становясь неестественно прямым и жёстким. Он отводит взгляд, и его лицо застывает в нейтральной маске.\n«Понял. – голос звучит глухо, без обычных переливов. – Не буду мешать».",
        speaker: "Осётрик",
        next: 'osetrik_h_order'
    },
    'osetrik_h_order': {
        text: "«Сделай мне… Что-то на своё усмотрение, хорошо? – он произносит, оборачиваясь и глядя в окно, избегая моего взгляда. – Только с сыром». (Осетр по-царски)",
        speaker: "Осётрик",
        type: 'order_placed',
        order: 'sturgeon' // Любимое блюдо
    }
};